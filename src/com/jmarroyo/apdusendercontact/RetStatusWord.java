...
public enum RetStatusWord 
{
    ...
    public static String getSWDescription(String swStr)
    {
        ...
        {
        	szDescriptionStr61_6C = swStr.substring(2,4) + " response bytes still available";
            return szDescriptionStr61_6C;
        }
        else if (swStr.substring(0,2).equals("6C"))
        {
        	szDescriptionStr61_6C = "Wrong length Le:" + swStr.substring(2,4) + " indicates the exact length";
            return szDescriptionStr61_6C;
        }
